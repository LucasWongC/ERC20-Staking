    ...
    for (let i = 0; i < this.state.numberOfStake; i++) {
      ...
      if (archived_string === "archived") {
        ...
        if (typeof this.state.stakeID !== "undefined") {
          this.cookies.set("stake" + this.state.stakeID, "unarchived", {
            path: "/",
          });
          archived = false;
        }
            ...
            <Grid item>
              <Grid container direction="row" alignItems="center">
                ...
                <Typography variant="h4" component="h4">
                  <Trans i18nKey="staking_list.title" />
                </Typography>
              </Grid>
            </Grid>
            <Grid item>
              {this.state.referralLoaded &
                (this.state.numberOfActiveStake !== -1) && (
                <AccountInfo
            ...
            <Grid item>
              {this.state.stakingList === "" ? (
                <Typography color="textSecondary">
                  <Trans i18nKey="staking_list.noStakePresent" />
                </Typography>
              ) : (
                this.state.stakingList
              )}
