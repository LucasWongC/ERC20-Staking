...
class UserBox extends Component {
  ...
  async getTokenAddress() {
    ...
    const response = await this.state.stakingInstance.methods
      .getTokenAddress()
      .call();
          ...
          >
            <List>
              <ListItem>
                <Avatar
                  alt="logo"
                  src="https://www.bitcoincompany.it/wp-content/uploads/2019/08/BITN-Token-RGB-256x256.png"
                  style={{ margin: 10 }}
                />
                <ListItemText
                  primary={<Trans i18nKey="sideMenu.menuTitle" />}
                />
              </ListItem>
              <ListItem
                button
              ...
              >
                ...
                <ListItemText
                  primary={<Trans i18nKey="sideMenu.homeEntry" />}
                />
              </ListItem>
              <ListItem
                button
              ...
              >
                ...
                <ListItemText
                  primary={<Trans i18nKey="sideMenu.stakingForm" />}
                />
              </ListItem>
              <ListItem
                button
              ...
              >
                ...
                <ListItemText
                  primary={<Trans i18nKey="sideMenu.stakeList" />}
                />
              </ListItem>
              <ListItem
                button
              ...
              >
                ...
                <ListItemText
                  primary={<Trans i18nKey="sideMenu.referrals" />}
                />
              </ListItem>
              <Divider />
              <ListItem
              ...
              >
                ...
                <ListItemText
                  primary={<Trans i18nKey="sideMenu.crowdsaleEntry" />}
                />
              </ListItem>
              <Divider />
              <ListItem>
              ...
              <ListItem button onClick={this.toggleDrawer(null, false)}>
                ...
                <ListItemText
                  primary={<Trans i18nKey="sideMenu.closeEntry" />}
                />
              </ListItem>
            </List>
          </SwipeableDrawer>
