...
class FinalShutdownBox extends Component {
  ...
  handleReturnPot(event) {
    ...
    this.state.contractInterface.methods
      .returnPot(this.state.potToReturn)
      .send({ from: this.state.account })
      .then((result) => {
        console.log(result);
          ...
          >
            <Grid item>
              <Typography variant="body1" component="h3">
                Press the button to start the final shutdown on{" "}
            ...
            <Grid item>
              <Typography variant="body1" component="h3">
                Chose the amount to withdraw from the pot
              </Typography>
              <TextField
                value={this.state.potToReturn}
                onChange={this.handlePotChange}
              ></TextField>
            </Grid>
            <Grid item>
              <Button
