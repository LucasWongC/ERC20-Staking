...
class DepositPot extends Component {
  ...
  depositIntoPot() {
    this.state.contractInterface.methods
      .depositPot(this.state.realDepositAmount.toString())
  ...
  async getApprove() {
    ...
    await this.state.tokenInstance
      .approve(
        ...
        this.state.realDepositAmount.toString(),
    ...
    this.state.contractInterface.methods
      ...
      .catch((err) => {
        ...
        this.props.enqueueSnackbar(
          "Unable to fetch the potential withdraw amount",
          {
            variant: "error",
            anchorOrigin: {
              vertical: "bottom",
          ...
          >
              ...
              <div>
                {this.state.approvementConfirmed && (
                  <Typography variant="body1" component="h3">
                    Approvement confirmed, waiting for the deposit
                    confirmation...
                  </Typography>
                )}
            ...
            <Grid item>
              <Typography variant="body1" component="h6">
                Current Pot: <b>{this.state.currentPot}</b>{" "}
                {this.state.tokenSymbol}
              </Typography>
            </Grid>
            <Grid item>
              <Typography variant="body1" component="h6">
                Potential Withdraw: <b>{this.state.potentialWithdraw}</b>{" "}
                {this.state.tokenSymbol}
              </Typography>
            </Grid>
            <Grid item>
              <Typography variant="body1" component="h6">
                Machine State: <b>{this.state.machineState}</b>{" "}
                {this.state.tokenSymbol}
              </Typography>
            </Grid>
          </Grid>
