  ...
  render() {
    return (
      ...
      >
        ...
        <Grid item>
          <TextField
            label="Amount of BITN"
            onChange={this.handleBITNChange}
            value={this.state.amountOfBITN}
          ></TextField>
        </Grid>
        <Grid item>
          <TextField
            label="Amount of wei"
            value={this.state.amountOfWEI}
          ></TextField>
        </Grid>
        <Grid item>
          <TextField
            label="Amount of ETH"
            value={this.state.amountOfETH}
          ></TextField>
        </Grid>
      </Grid>
    );
