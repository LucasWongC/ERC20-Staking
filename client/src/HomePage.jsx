        ...
        >
          ...
          >
            ...
            <Grid item>
              <Avatar
                alt="logo"
                src="https://www.bitcoincompany.it/wp-content/uploads/2018/07/Logo-finale-trasparente.png"
                style={{ width: 200, height: 200 }}
              />
            </Grid>
            <Grid item>
              <Typography>
                <Trans i18nKey="HomePage.tokenBalance" />:{" "}
                <b>{this.state.tokenBalance}</b>
              </Typography>
            </Grid>
            <Grid item>
              <Typography>
                <Trans i18nKey="HomePage.stakeToken" />
              </Typography>
              <Button
                variant="outlined"
                component={Link}
            ...
            <Grid item>
              <Typography>
                <Trans i18nKey="HomePage.needToken" />
              </Typography>
              <Button
                variant="outlined"
                component={Link}
