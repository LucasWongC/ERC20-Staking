...
class MachineState extends Component {
  ...
  async getMachineState() {
    ...
    await this.state.contractInterface.methods
      .getMachineState()
      .call()
      .then((rawResult) => {
    ...
    return (
      <div>
        {this.state.loading ? (
          <div>
            <Typography>
              <Trans i18nKey="sideMenu.loadingMachineState" />
              ...
            </Typography>
            <CircularProgress />
          </div>
          ...
          >
            <Grid item>
              <Typography>
                <Trans i18nKey="sideMenu.machineState" />:{" "}
            ...
            <Grid item>
              ...
              >
                <Grid item>
                  <Typography>
                    {this.state.statePercent}%{" "}
                    <Trans i18nKey="sideMenu.machineAvailableAmount" />
                  </Typography>
                </Grid>
                <Grid item>
                  <PieChart
                    ...
                    data={[
                      {
                        title: "Available",
                        value: Number(this.state.statePercent),
                        color: "#E38627",
                      },
                      {
                        title: "Supplied",
                        value: 100 - Number(this.state.statePercent),
                        color: "#A28127",
                      },
                    ]}
                  />
